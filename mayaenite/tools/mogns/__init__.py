...
class MayaeniteToolMognsExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[mayaenite.tool.mogns] MayaeniteToolMognsExtension startup", flush=True)

    def on_shutdown(self):
        print("[mayaenite.tool.mogns] MayaeniteToolMognsExtension shutdown", flush=True)
